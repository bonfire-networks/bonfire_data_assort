defmodule Bonfire.Data.Assort.MixProject do
  ...
  def project do
    [
      ...
      description: "Database models for tags, categories, and otherwise linked or ranked items in the bonfire ecosystem",
      ...
      package: [
        licenses: ["MPL 2.0"],
        links: %{
          "Repository" => "https://github.com/bonfire-networks/bonfire_data_assort",
